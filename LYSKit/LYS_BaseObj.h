...
/**
 ...
 @param queue 自定义的队列
 */
+ (void)ly_addAsync:(LYSGCDAction)action
...
/**
 ...
 @param queue 自定义的队列
 */
+ (void)ly_addSync:(LYSGCDAction)action
             queue:(dispatch_queue_t)queue;
...
/**
 ...
 @param queue 队列
 */
+ (void)ly_add_Barrier_AsyncAction:(LYSGCDAction)firstAction
                             queue:(dispatch_queue_t)queue;
...
/**
 ...
 @param action 延迟事件
 */
+ (void)ly_addAfter:(NSTimeInterval)interval
...
/**
 ...
 @param action 重复的事件
 */
+ (void)ly_addRepeat:(NSInteger)num
              action:(LYSGCDAction)action;
 ...
 */
+ (void)ly_add_Group_AsyncAction:(void(^)(dispatch_group_t group,dispatch_queue_t queue))firstAction
                    notifyAction:(LYSGCDAction)action;
 ...
 */
+ (void)ly_add_Group_AsyncAction:(LYSGCDAction)firstAction
