#
#  Be sure to run `pod spec lint LYSKit.podspec' to ensure this is a
...
A very useful base framework that integrates some of the common code blocks in development with apis
  ...
  # Or just: s.author    = "LIYANGSHUAI"
  # s.authors            = { "LIYANGSHUAI" => "liyangshuai163@163.com" }
  # s.social_media_url   = "http://twitter.com/LIYANGSHUAI"
  ...
  s.source       = { :git => "https://github.com/LIYANGSHUAI/LYSKit.git", :tag => "0.0.3" }
